...
class Slider:
	def __init__(self, x: int, y: int, width: int, height: int, color: tuple[int, int, int]=None, min_val=0, max_val=100, is_list: list=[], choppy: bool=False, width_fill: int=20, color_fill: tuple[int, int, int]=None,
		text: str="", text_lang:str = "english", text_color: tuple[int, int, int]=(255,255,255), outline: tuple[int, int, int]=None, outline_thickness: int=2, font_path: str=None, font_size: int=None,
	):
		self.x = x
		self.y = y
		self.width = width
