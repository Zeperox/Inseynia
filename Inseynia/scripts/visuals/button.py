...
class Button:
	def __init__(self, x: int, y: int, width: int, height: int, color: tuple[int, int, int]=None, text: str="", text_lang:str = "english", text_color: tuple[int, int, int]=(255,255,255),
